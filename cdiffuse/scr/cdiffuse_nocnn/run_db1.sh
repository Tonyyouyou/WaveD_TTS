...
model_name="/g/data/wa66/Xiangyu/Result/db1_cdiffuse_nocnn"
...
python /home/561/xz4320/WaveD_TTS/cdiffuse/scr/cdiffuse_nocnn/__main__.py ${model_name} ${target_wav_root} ${noisy_wav_root} ${train_spec_list}  --max_steps ${max_steps}  --voicebank &> ./db1nocnn.log