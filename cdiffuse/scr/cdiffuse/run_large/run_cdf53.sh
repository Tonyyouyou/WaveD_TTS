...
model_name="/g/data/wa66/Xiangyu/Result/wavSE/large/cdf53_cdiffuse_cnn"
...
python /home/561/xz4320/WaveD_TTS/cdiffuse/scr/cdiffuse/__main__.py ${model_name} ${target_wav_root} ${noisy_wav_root} ${train_spec_list}  --waveletbase ${waveletbase} --max_steps ${max_steps}  --voicebank &> ./cdf53.log