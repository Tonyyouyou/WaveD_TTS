...
model_name="/g/data/wa66/Xiangyu/Result/wavSE/large/coif1_cdiffuse_cnn"
...
python /home/561/xz4320/WaveD_TTS/cdiffuse/scr/cdiffuse/__main__.py ${model_name} ${target_wav_root} ${noisy_wav_root} ${train_spec_list}  --max_steps ${max_steps}  --voicebank &> ./coif1.log