...
model_dir='/g/data/wa66/Xiangyu/Result/wavTTS_without/db1'
data_dirs='/g/data/wa66/Xiangyu/Data/LJSpeech-1.1/wavs'
max_steps=1000000

python3 /home/561/xz4320/WaveD_TTS/diffwave/src/diffwave_nocnn/__main__.py ${model_dir} ${data_dirs} --max_steps ${max_steps} &> ./db1nocnn.log