...
model_dir='/g/data/wa66/Xiangyu/Result/waveletTTS_VCTK/base/bior1.3nocnn'
data_dirs='/g/data/ey69/xiangyu_ey69/data/DS_10283_2651/wav48'
waveletbase='bior1.3'
max_steps=1000000

python3 /home/561/xz4320/WaveD_TTS/diffwave/src/diffwave_nocnn/__main__.py ${model_dir} ${data_dirs} --waveletbase ${waveletbase} --max_steps ${max_steps} &> ./bior1.3.log