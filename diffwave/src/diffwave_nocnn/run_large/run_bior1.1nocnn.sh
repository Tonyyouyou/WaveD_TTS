...
model_dir='/g/data/wa66/Xiangyu/Result/wavTTS/large/bior1nocnn'
data_dirs='/g/data/wa66/Xiangyu/Data/LJSpeech-1.1/wavs'
waveletbase='bior1.1'
max_steps=1000000

python3 /home/561/xz4320/WaveD_TTS/diffwave/src/diffwave_nocnn/__main__.py ${model_dir} ${data_dirs} --waveletbase ${waveletbase} --max_steps ${max_steps} &> ./bior1.log