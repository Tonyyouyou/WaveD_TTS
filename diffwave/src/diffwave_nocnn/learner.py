...
def _train_impl(replica_id, model, dataset, args, params):
  ...
  end_time = time.time()
  print(f'1 Epoch took {end_time-start_time} seconds.')
...
def train(args, params):
  ...
  # print(f"audio size: {train_data['audio'].size()}")
  # print(f"spectrogram size: {train_data['spectrogram'].size()}")
  # print(f"dataset lengh: {len(dataset)}")
