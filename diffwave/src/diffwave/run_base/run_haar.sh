...
model_dir='/g/data/wa66/Xiangyu/Result/waveletTTS_VCTK/cnn/haarcnn'
data_dirs='/g/data/ey69/xiangyu_ey69/data/DS_10283_2651/wav48'
waveletbase='haar'
max_steps=1000000

python3 /home/561/xz4320/WaveD_TTS/diffwave/src/diffwave/__main__.py ${model_dir} ${data_dirs} --waveletbase ${waveletbase} --max_steps ${max_steps} &> ./haar.log